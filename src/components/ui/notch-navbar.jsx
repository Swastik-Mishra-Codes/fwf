...
// Helper component for navigation links using react-router-dom
...
// Sigma Logo SVG (matching the existing Logo atom branding)
const SigmaLogo = () => (
  <Link to="/" className="flex items-center justify-center relative group" aria-label="MathClub IIIT Raichur home">
    <svg
      className="w-8 h-8 hover:scale-110 transition-transform relative z-10"
      viewBox="0 0 40 40"
      fill="none"
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 h-10 bg-[#040713] z-20 relative min-w-0">
        ...
        <div className="flex h-16 relative z-10 shrink-0 -ml-px">
          ...
          <div className="flex-1 h-full relative min-w-0 -ml-px">
            ...
            <div className="absolute inset-0 bg-[#040713]">
        ...
        <div className="flex-1 h-10 bg-[#040713] z-20 relative min-w-0 -ml-px">
          <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
            <line x1="0" y1="39.5" x2="100%" y2="39.5" stroke="#1e3457" strokeOpacity={0.6} strokeWidth={0.5} />
            <line x1="0" y1="36.5" x2="100%" y2="36.5" stroke="#1e3457" strokeOpacity={0.3} strokeWidth={0.5} />
          </svg>
